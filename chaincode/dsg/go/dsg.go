...
func (s *SmartContract) CreateSend(ctx contractapi.TransactionContextInterface,OrderId string,Grams string,SenderUserId string,ReceiverUserId string) error {
...
func (s *SmartContract) CreateTrade(ctx contractapi.TransactionContextInterface,OrderId string,Grams string,UserId string) error {
